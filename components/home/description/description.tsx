    ...
    return (
        <div className={s.wrapper}>
            <DescriptionItem img={image1}>
                <span style={{fontSize: '32px', fontWeight: 400, display: 'block', marginBottom: '10px'}}>ООО «ГеоСтрой» –</span> надёжный застройщик в Республике Башкортостан, воплощающий мечты в качественных
